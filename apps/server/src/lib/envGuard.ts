 ...
 * been evaluated — and modules like lib/supabase.ts (SUPABASE_URL) and
 * lib/techToken.ts (TECH_SIGNING_* in production) throw at import on a missing
 * secret. The clear, complete report would arrive after the single-line crash
