      ...
      >
        ...
        {data && (
          <div style={{ padding: "20px 24px" }}>
            ...
            {/* Printable receipt */}
            {/* These class styles previously existed only in the print window,
                so the on-screen preview rendered labels/values with no spacing
                ("Completed Orders0"). Scope them to the preview here too. */}
            <style>{`
              .zreport-print .row { display: flex; justify-content: space-between; padding: 2px 0; }
              .zreport-print .total-row { display: flex; justify-content: space-between; font-weight: bold; border-top: 1px solid currentColor; padding-top: 4px; margin-top: 4px; }
              .zreport-print .section-title { font-weight: bold; text-transform: uppercase; font-size: 11px; margin: 8px 0 4px; letter-spacing: 0.05em; }
              .zreport-print .center { text-align: center; }
              .zreport-print .bold { font-weight: bold; }
              .zreport-print .divider { border-top: 1px dashed currentColor; margin: 8px 0; }
            `}</style>
            <div
              ref={printRef}
              className="zreport-print"
              style={{
