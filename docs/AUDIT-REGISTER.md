...
### A328 · P3 · FIX BUILT 2026-09-25 · Phase 2 slice 4b-1 — the web POS + shared components follow the action theme
...
| 4 | Web: picker + live preview (**A327** CLOSED); 4b-1 web POS + shared components (**A328** FIX BUILT); 4b-2 back-office (~606 uses — product decision first) | dashboard | in progress |
