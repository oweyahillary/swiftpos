...
### A324 · P3 · FIX BUILT 2026-09-24 · Phase 2 slice 1 — the theme registry (`themes.ts`): seven action themes + the brand-colour rule
...
|---|---|---|---|
| 1 | Theme registry `themes.ts` + checks | code + test, no visible change | **A324** FIX BUILT |
| 2 | `theme_id` (migration 106), cloud validation, `/pos/init`, till mirror, `themes` flag (off) | cloud + prod migration + desktop | — |
