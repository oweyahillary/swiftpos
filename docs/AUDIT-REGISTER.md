...
### A326 · P3 · FIX BUILT 2026-09-24 · Phase 2 slice 3 — the till's colours follow the theme (only when themes are ON)
...
| 3 | Till: CSS-variable tokens; classify the till's green uses (action vs status); brand layer; a raw-green gate | desktop | **A326** FIX BUILT |
| 4 | Web: picker + live preview + pairing on the Branding page; dashboard's 221 green uses classified | dashboard (maybe 2 deliveries) | — |
