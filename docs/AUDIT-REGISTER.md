...
| Open | **A: 1 P0 · 16 P1 · 18 P2 · 8 P3 — D: 1 P0 · 2 P1 · 2 P2 · 3 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
| Counts | A-P0: A17 · A-P1: A179 A151 A54 A18 A19 A20 A50 A24 A129 A158 A160 A161 A162 A163 A164 A211 · A-P2: A189 A188 A182 A168 A22 A23 A53 A141 A146 A159 A157 A197 A207 A209 A212 A217 A224 A229 · A-P3: A186 A13 A139 A148 A204 A216 A230 — D-P0: D1 · D-P1: D3 D4 · D-P2: D7 D18 · D-P3: D9 D10 D17 |
...
**CLOSED 2026-09-05 (live DB pass, post-deploy):** the boot self-heal ran and the live catalogue now
holds every canonical key — verified in the Supabase SQL editor (`A213-verify.sql`): expected 25,
registered_live 25, missing_keys (none). The A211/A212/A220 failure mode (live catalogue drifting missing
a code-referenced key) can no longer occur, and the CI gate keeps the canonical list complete.
