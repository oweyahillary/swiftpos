...
### A325 · P3 · FIX BUILT 2026-09-24 · Phase 2 slice 2 — `theme_id` + the `themes` flag, cloud to till (migration 106, schema 54)
...
| 2 | `theme_id` (migration 106), cloud validation, `/pos/init`, till mirror, `themes` flag (off) | cloud + prod migration + desktop | **A325** FIX BUILT |
| 3 | Till: CSS-variable tokens; classify ~108 green uses (action vs status); brand layer; a raw-green gate | desktop | — |
