...
### A301 · P3 · FIX BUILT · Desktop-local branding WRITE path — branding:set + raster logo prep (accent + PNG/JPEG)
...
### A302 · P3 · FIX BUILT · Tech-gated branding FEED — accent picker + PNG/JPEG logo upload (makes A301's write path visible)
...
### A303 · P3 · FIX BUILT · Cloud branding store — business_branding table + server CRUD (the cloud half of A295 sync)
...
### A304 · P3 · FIX BUILT · Branding sync-down — /pos/init serves branding + till pulls it to the local mirror (remote-wins)
