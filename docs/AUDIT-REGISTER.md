...
| Open | **A: 3 P0 · 18 P1 · 19 P2 · 7 P3 — D: 1 P0 · 2 P1 · 2 P2 · 3 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
| Counts | A-P0: A17 A152 A167 · A-P1: A169 A151 A54 A18 A19 A20 A50 A24 A3 A12 A129 A145 A158 A160 A161 A162 A163 A164 · A-P2: A168 A22 A23 A53 A8 A69 A73 A130 A133 A140 A141 A143 A144 A146 A147 A159 A157 A165 A166 · A-P3: A13 A70 A139 A142 A148 A149 A154 — D-P0: D1 · D-P1: D3 D4 · D-P2: D7 D18 · D-P3: D9 D10 D17 |
...
### A169 · P1 · OPEN · Offline sales are attributed to the OWNER, not the cashier

Found while fixing A168. The server sets `cashier_id = req.userId` — the token
subject (`apps/server/src/routes/orders.ts`) — and does not read a cashier from
...
and every offline sale is credited to the owner on the cloud. Staff Performance
and SPLH are wrong by exactly the offline volume, silently. Online shifts are
correct (real staff token → correct subject).

NOT fixed here, and not a one-liner: the server has no way to trust a cashier
claim from a till without the device-grant / node roster machinery, so accepting
a payload `cashier_id` blind would let any till credit any user (rule 20 — do not
ship the thing whose guard does not exist; name the blocker). The honest fixes
are (a) the A164 desktop device-grant cutover so an offline till still presents a
per-cashier identity, or (b) a signed roster claim the server can verify. Left
OPEN P1 with the blocker named. Surfaced 2026-08-27.

### A167 · P0 · OPEN · Offline PIN sign-in throws `NOT NULL constraint failed: staff_session.token`
...
### A152 · P0 · OPEN · Offline auth doesn't fall back when the cloud is DOWN-but-responding (5xx) — tills locked out during the 2026-08-23 Render outage
...
### A165 · P2 · OPEN · One menu upload for everything — sparse, name-keyed import (products slice built)
...
### A166 · P2 · OPEN · Day-to-day bulk price changes without a spreadsheet ("all sodas +20 / +10% / round")
