...
| Tree | `dev`, post-A184 (last pushed `f89b8ff`; this edit commits on top), desktop **v0.5.48**, `LOCAL_SCHEMA_VERSION` **52**, migrations **→ 102** (files up to 102; 93 & 94 live in prod per the 2026-08-28 real-till verification; 90's A129 delivery still pending prod-migrate), web/cloud runtime **Node 24**, desktop **Electron 43** |
