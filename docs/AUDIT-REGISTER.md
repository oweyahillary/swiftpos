...
| Open | **A: 0 P0 · 19 P1 · 36 P2 · 20 P3 — D: 1 P0 · 2 P1 · 2 P2 · 3 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
...
`avg_order_value = revenue/orders`. Caveat: an order with neither a cashier nor a shift
still shows Unknown. NOT verified here (rule 16): the live Staff report.
