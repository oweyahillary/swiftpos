...
| Open | **A: 1 P0 · 15 P1 · 16 P2 · 5 P3 — D: 1 P0 · 2 P1 · 2 P2 · 3 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
...
a cashier/owner are unaffected. **Next free ID A208.**
...
tab lists open drawers and force-close (with reason) releases one. **Next free ID A208.**
