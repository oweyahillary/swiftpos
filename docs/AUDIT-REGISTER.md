...
### A322 · P2 · OPEN · Shipped screens and the test print show two reference businesses' names to every client
...
### A321 · P2 · FIX BUILT 2026-09-23 · Web changes reach the till's DB but the open screen never refreshes — a sign-in/out is needed
...
| 5 Web Branding page + previews | A308 + A313 | receipt preview (A313) CLOSED on target; lock-screen preview + save verified (A1); **page → till (A2) and custom accent (A5) not yet run** — A308/A319 stay FIX BUILT |
...
| 7 Branded / un-branded / bad-accent / offline / A291 propagation | A301–A304 §A–§F 25/25; A278 | offline read re-verified (C1) and un-branded fallback (D1) on 2026-09-23; **propagation: data arrives, the open screen does not refresh — A278 open, A321** |
