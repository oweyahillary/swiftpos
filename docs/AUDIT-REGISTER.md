...
| Tree | `dev`, post-A184 (last pushed `f89b8ff`; this edit commits on top), desktop **v0.5.47**, `LOCAL_SCHEMA_VERSION` **52**, migrations **→ 102** (files up to 102; 93 & 94 live in prod per the 2026-08-28 real-till verification; 90's A129 delivery still pending prod-migrate), web/cloud runtime **Node 24**, desktop **Electron 43** |
| Open | **A: 0 P0 · 18 P1 · 17 P2 · 14 P3 — D: 0 P0 · 0 P1 · 0 P2 · 2 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
| Counts | A-P0: — · A-P1: A179 A54 A19 A20 A50 A24 A129 A158 A160 A161 A162 A163 A164 A211 A240 A265 A266 A267 A273 A274 A275 · A-P2: A189 A182 A168 A22 A23 A53 A141 A159 A157 A197 A209 A241 A245 A249 A259 · A-P3: A186 A13 A139 A148 A234 A237 A243 A251 A257 A258 A262 A18 A296 A298 A299 — D-P0: — · D-P1: — · D-P2: — · D-P3: D9 D10 |
...
lands in the file; (5) rotation raised 1MB -> 5MB (x2 = 10MB bounded) for the added volume. Additive;
