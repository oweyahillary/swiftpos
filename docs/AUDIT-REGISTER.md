...
| 4 Receipt logo (mono raster header) | A310–A313 | **IN PROGRESS.** A310 (shared/printing raster + `GS v 0` + renderer, opt-in toggle decided) FIX BUILT 2026-09-22; A311 data/sync, A312 desktop print, A313 web toggle + preview + bundle still to build |
