...
### A313 · P3 · FIX BUILT 2026-09-22 · Receipt logo, slice 4 (last) — the client-facing web page: opt-in toggle + receipt preview; web receipts carry the logo (SCOPE-A295 §6, §10 items 4–5, addendum §C)
...
### A312 · P3 · FIX BUILT 2026-09-22 · Receipt logo, slice 3 — the till prints it: tech-feed generates the raster, print path gates on the toggle (SCOPE-A295 §10 item 4; A310→A311→A312→A313)
...
### A311 · P3 · FIX BUILT 2026-09-22 · Receipt logo, slice 2 — the data + sync half: `receipt_logo_enabled` toggle, `logo_receipt` served and pulled, schema 53 (SCOPE-A295 §10 item 4; A310→A311→A312→A313)
...
### A320 · P3 · FIX BUILT 2026-09-23 · Product UPDATE accepts a whitespace-only name and saves it as ''
...
### A319 · P2 · FIX BUILT 2026-09-23 · Web Branding page's legibility rule has drifted from the till's — rejects colours the till accepts
...
### A318 · P3 · FIX BUILT 2026-09-23 · Products table clips its row actions — Edit/Delete invisible on categories with long descriptions
...
### A317 · P2 · FIX BUILT 2026-09-23 · Product save rejects an empty description — "expected string, received null"
...
### A316 · P1 · FIX BUILT 2026-09-23 · Web receipt logo is corrupt in the browser — Branding saves 400, web never prints the logo
...
### A315 · P3 · FIX BUILT 2026-09-23 · Receipt closing block can duplicate the owner's footer line
...
### A295 · P1 · OPEN (Phase 1 tracker) · Client branding — Phase 1 (SCOPE-A295 §1–§11 + 2026-09-19 addendum)
...
| 4 Receipt logo (mono raster header) | A310–A313 | **FIX BUILT (all four slices, 2026-09-22).** shared/printing raster + `GS v 0`; migration 105 toggle + `logo_receipt` served/pulled; till prints when enabled, tech feed generates; web page toggle + receipt preview, web receipts carry it. **Paper PASSED on XP-80 (A310 CLOSED).** Owed: on-screen (till + browser), migration 105 on prod, a real sale on a till |
| 5 Web Branding page + previews | A308 + A313 | FIX BUILT — lock-screen preview (A308) and **receipt preview (A313)** both present; browser check owed |
...
| 7 Branded / un-branded / bad-accent / offline / A291 propagation | A301–A304 §A–§F 25/25; A278 | offline read verified; propagation FIX BUILT, target check owed |
...
### A296 · P3 · FIX BUILT · Item Mix (manager desktop) was hard-wired to today — add the date-range filter the Orders tab already has
...
### A298 · P3 · FIX BUILT · Build provenance — stamp the git SHA + build time into every desktop build (Tech screen + launch log)
...
### A299 · P3 · FIX BUILT · Logging — capture ALL errors (main + renderer) and event summaries into swiftpos.log, not just success lines
...
### A300 · P3 · FIX BUILT · Rule 21 — getServerUrl() renamed to getCloudUrl()
...
### A305 · P3 · FIX BUILT · Migration test runner hardened — per-test timeout + parallel pool + self-test (stops CI hangs)
...
### A306 · P3 · FIX BUILT · Auto-update UX — "updating" banner + manager-gated visible restart (no more silent vanish)
...
### A308 · P3 · FIX BUILT · Web branding settings page — owner sets accent + logo from the dashboard (SCOPE §6)
...
### A277 · P2 · FIX BUILT · Receipt omits the Catering/Tourism Levy (CTL) line
...
### A278 · P2 · FIX BUILT · Web→till changes aren't instant — a till restart is needed to pick them up
...
### A279 · P3 · OPEN · POS has no visible category-filter control
