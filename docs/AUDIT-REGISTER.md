...
| Open | **A: 0 P0 · 19 P1 · 36 P2 · 19 P3 — D: 1 P0 · 2 P1 · 2 P2 · 3 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
| Counts | A-P0: — · A-P1: A179 A151 A54 A18 A19 A20 A50 A24 A129 A158 A160 A161 A162 A163 A164 A211 A240 A242 A254 · A-P2: A189 A188 A182 A168 A22 A23 A53 A141 A146 A159 A157 A197 A207 A209 A212 A217 A224 A229 A231 A241 A244 A245 A246 A248 A249 A250 A252 A253 A255 · A-P3: A186 A13 A139 A148 A204 A216 A230 A232 A233 A234 A237 A243 A247 A251 A257 A258 A261 A262 — D-P0: D1 · D-P1: D3 D4 · D-P2: D7 D18 · D-P3: D9 D10 D17 |
...
intentionally left exclusive. Guard test (3). NOT verified here (rule 16): the live
reports; if "Unknown" persists after this, the cashier_id on those orders does not match a
users row (likely offline-sync) — send me one such order's cashier_id and I'll trace it.
Delivery: `docs/MANIFEST-2026-09-07-s.md`.

### A260 · P2 · OPEN · Printed documents show "SwiftPOS" instead of the client's business name
...
on the owner session, so a manager (staff user) never populates it. **Not built** — needs
the business name available to staff sessions (either `BusinessContext` fetching for any
authenticated session if `/api/business` is staff-readable, or threading the name the
manager already has from their session). Filed 2026-09-07; build next.

### A261 · P3 · OPEN · No "Reprint receipt" (duplicate) action on the Orders page
...
a per-row "Reprint" button. **Not built** — needs the order-items fetch + `buildReceiptOrder`
reprint plumbing. Filed 2026-09-07; build next.

### A262 · P3 · OPEN · No shift report under Shifts

Owner request ("under shift can we have shift report"). A per-shift report (cashier,
open/close, orders, revenue, payment breakdown, cash reconciliation) — reuse the existing
`/api/reports/shifts` + Z-report (`/api/reports/eod`) data behind a printable view on the
Shifts page. **Not built** — net-new view + print. Filed 2026-09-07; build next.
