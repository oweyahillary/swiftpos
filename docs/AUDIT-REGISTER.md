...
### A310 · P3 · FIX BUILT 2026-09-22 · Receipt logo, slice 1 — `shared/printing` learns to print a mono raster (SCOPE-A295 §10 item 4, first of four slices A310–A313)
...
| 4 Receipt logo (mono raster header) | A310–A313 | **FIX BUILT (all four slices, 2026-09-22).** shared/printing raster + `GS v 0`; migration 105 toggle + `logo_receipt` served/pulled; till prints when enabled, tech feed generates; web page toggle + receipt preview, web receipts carry it. Owed: paper, on-screen (till + browser), migration 105 on prod |
