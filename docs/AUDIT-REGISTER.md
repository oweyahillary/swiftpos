...
| Open | **A: 0 P0 · 19 P1 · 17 P2 · 19 P3 — D: 0 P0 · 0 P1 · 0 P2 · 2 P3** (re-derived from the body by `check-register-consistency`, not hand-counted) |
...
| 4 Receipt logo (mono raster header) | — | **NOT BUILT.** `logo_receipt` exists as a column on both sides; nothing thresholds the upload and neither `escposBridge.ts` nor `shared/printing` prints a logo |
