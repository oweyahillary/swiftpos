-- ─────────────────────────────────────────────────────────────────────────────
-- Migration 66 — payment legs reconcile to total + tip
--
...
VALUES ('66_order_atomic_tip_reconciliation',
        'Legs reconcile to total + tip. Fixes every tipped sale being refused.')
